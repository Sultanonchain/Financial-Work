...
let priceChartInstance, dcfChartInstance, valuationHistoryChartInstance, valuationHistoryIVChartInstance;
...
function destroyValuationHistoryChart() {
  ...
  if (valuationHistoryIVChartInstance) {
    valuationHistoryIVChartInstance.destroy();
    valuationHistoryIVChartInstance = null;
  }
}
...
const I18N = {
  es: {
    ...
    "common.addPortfolio": "Añadir a la cartera",
    "nav.back": "Volver a la investigación",
    "nav.backSearch": "Volver a la búsqueda",
    "nav.backStocks": "Volver a las acciones",
    "onb.title": "¿Primera vez aquí? Léelo en 20 segundos.",
    "onb.text": "VALUS estima el <strong>valor justo</strong> de cada acción con un modelo de <strong>flujo de caja descontado (DCF)</strong> a 10 años, proyectando los flujos futuros al presente y dividiéndolos entre el número de acciones. Compáralo con el precio de mercado y obtienes un <strong>margen de seguridad</strong> (MOS). Cuanto mayor sea el descuento, mejor será la <strong>calificación A-F</strong>.",
    "onb.gotit": "Entendido ✓",
    "hero.title": "Busca cualquier acción.<br/>Entiende su valoración al instante.",
    "hero.subtitle": "Modelo DCF gratuito a 10 años, estimación de valor intrínseco, margen de seguridad y un desglose transparente de cada supuesto: rigor de nivel institucional para estudiantes e inversores curiosos.",
    "home.topPicks": "Mejores selecciones",
    "home.topPicksSub": "VALUS cree que estas son las más infravaloradas ahora mismo",
    "home.trending": "Tendencia de hoy",
    "search.ph": "Ticker o empresa (p. ej. AAPL, Microsoft, Berkshire)",
    "search.analyze": "Analizar",
    "sort.ticker": "Ticker",
    "sort.mos": "MOS",
    "sort.added": "Añadidas recientemente",
    "pf.emptyTitle": "Aún no tienes acciones en tu cartera",
    "pf.emptySub": "Busca cualquier ticker y pulsa \"Añadir a la cartera\" para empezar a seguirlo.",
    "pf.startAdding": "Empieza a añadir acciones",
    "wl.emptyTitle": "Aún no tienes acciones en tu lista de seguimiento",
    "wl.emptySub": "Busca cualquier ticker y pulsa \"Añadir a la lista\" para empezar a seguirlo.",
    "compare.detail": "Elige 2 o 3 acciones. Ejecutaremos VALUS en cada una y mostraremos las diferencias en precio, valor justo, capitalización, objetivo de analistas, calidad, foso y momento. Lo mejor de cada fila se resalta.",
    "compare.run": "Comparar",
    "compare.loading": "Ejecutando VALUS en ambas…",
    "compare.phA": "Ticker 1, p. ej. AAPL",
    "compare.phB": "Ticker 2, p. ej. MSFT",
    "compare.phC": "Ticker 3 (opcional)",
    "grade.intro": "Cada acción recibe una sola letra A-F que compara su <strong>precio de mercado actual</strong> con el <strong>valor justo de VALUS</strong>. El porcentaje junto a la letra es el <em>margen de seguridad</em>: cuánto por debajo (positivo) o por encima (negativo) del valor justo cotiza la acción.",
    "grade.fineprint": "La letra se deriva únicamente del modelo DCF y del precio actual. <strong>No</strong> es una señal de compra/venta; lee el veredicto completo y la metodología subyacente antes de actuar. <a href=\"/methodology\" style=\"color: var(--accent);\">Lee la metodología →</a>",
    "plus.intro": "Desbloquea el kit institucional por <strong>$2 / mes</strong>.",
    "plus.perk1": "<strong>Búsquedas ilimitadas.</strong> Sin límite diario en ningún ticker.",
    "plus.perk2": "<strong>Análisis de escenarios</strong>: valor justo ponderado bajista / base / alcista.",
    "plus.perk3": "<strong>Operaciones de insiders</strong>: informes Form 4 para cada ticker.",
    "plus.perk4": "<strong>Historial de valoración de 5 años</strong>: repaso del VI del modelo vs precio de mercado.",
    "plus.perk5": "<strong>Publicar en la clasificación</strong>: presume de tus selecciones infravaloradas.",
    "plus.perk6": "<strong>Actualización prioritaria de datos</strong>: cachés más frescas en cada análisis.",
    "plus.cta": "VALUS+, Ilimitado por $2/mes",
    "plus.fineprint": "Pago seguro vía Stripe. Cancela cuando quieras; tu acceso continúa hasta el final del período de facturación actual.",
    "signin.detail": "VALUS es gratis sin necesidad de cuenta: busca cualquier acción, mueve los controles del DCF y explora la clasificación, todo sin iniciar sesión. Inicia sesión solo cuando quieras guardar una cartera entre dispositivos o publicar en la clasificación pública.",
    "signin.google": "Continuar con Google",
    "etf.52wHigh": "Máx. 52 sem.",
    "etf.52wLow": "Mín. 52 sem.",
    "etf.ytd": "Rentab. YTD",
    "etf.expense": "Ratio de gastos",
    "btc.tagline": "El mayor activo de la historia de la humanidad.<br/><span>Indestructible. Inevitable. Inviolable.</span>",
    ...
    "common.back": "Volver",
    "lb.subtitle": "Mira quién ha encontrado las mejores oportunidades de valor. Ordenado por margen de seguridad.",
    "lb.sortLabel": "Ordenar:",
    "lb.avgMos": "MOS medio",
    "lb.recent": "Más recientes",
    "lb.size": "Más posiciones",
    "lb.loading": "Cargando clasificación…",
    "btc.spot": "Contado · BTC/USD",
    "btc.mcap": "Capitalización",
  },
  zh: {
    "nav.signin": "登录",
    "nav.watchlist": "关注列表",
    ...
    "common.addPortfolio": "加入组合",
    "nav.back": "返回研究",
    "nav.backSearch": "返回搜索",
    "nav.backStocks": "返回股票",
    "onb.title": "第一次来？20 秒读懂。",
    "onb.text": "VALUS 用 10 年期<strong>现金流折现（DCF）</strong>模型估算每只股票的<strong>合理价值</strong>，把未来现金折算到今天再除以股本。将其与市场价格比较，就得到<strong>安全边际</strong>（MOS）。折价越大，<strong>A-F 评级</strong>越高。",
    "onb.gotit": "知道了 ✓",
    "hero.title": "搜索任意股票。<br/>立即看懂它的估值。",
    "hero.subtitle": "免费 10 年期 DCF 模型、内在价值估算、安全边际，以及对每个假设的透明拆解，为学习者与好奇的投资者提供机构级的严谨。",
    "home.topPicks": "精选推荐",
    "home.topPicksSub": "VALUS 认为这些目前最被低估",
    "home.trending": "今日热门",
    "search.ph": "股票代码或公司（如 AAPL、Microsoft、Berkshire）",
    "search.analyze": "分析",
    "sort.ticker": "代码",
    "sort.mos": "安全边际",
    "sort.added": "最近添加",
    "pf.emptyTitle": "你的组合中还没有股票",
    "pf.emptySub": "搜索任意代码并点击“加入组合”即可开始跟踪。",
    "pf.startAdding": "开始添加股票",
    "wl.emptyTitle": "你的关注列表中还没有股票",
    "wl.emptySub": "搜索任意代码并点击“加入关注列表”即可开始跟踪。",
    "compare.detail": "选择 2 到 3 只股票。我们会对每只运行 VALUS，并展示价格、合理价值、市值、分析师目标、质量、护城河与动能上的差异。每行最优者会高亮。",
    "compare.run": "比较",
    "compare.loading": "正在对两者运行 VALUS…",
    "compare.phA": "代码 1，如 AAPL",
    "compare.phB": "代码 2，如 MSFT",
    "compare.phC": "代码 3（可选）",
    "grade.intro": "每只股票获得一个 A-F 字母，用以比较其<strong>当前市场价格</strong>与 <strong>VALUS 合理价值</strong>。字母旁的百分比是<em>安全边际</em>，即股价低于（正）或高于（负）合理价值的幅度。",
    "grade.fineprint": "该字母完全由 DCF 模型和当前价格得出。它<strong>不是</strong>买卖信号；行动前请阅读完整评级与底层方法论。<a href=\"/methodology\" style=\"color: var(--accent);\">阅读方法论 →</a>",
    "plus.intro": "以 <strong>$2 / 月</strong> 解锁机构级工具箱。",
    "plus.perk1": "<strong>无限搜索。</strong> 任何代码均无每日上限。",
    "plus.perk2": "<strong>情景分析</strong>：看跌 / 基准 / 看涨加权合理价值。",
    "plus.perk3": "<strong>内部人交易</strong>：每只代码的 Form 4 申报。",
    "plus.perk4": "<strong>5 年估值历史</strong>：模型内在价值 vs 市场价格回放。",
    "plus.perk5": "<strong>发布到排行榜</strong>：秀出你低估的选股。",
    "plus.perk6": "<strong>数据优先刷新</strong>：每次分析都有更新的缓存。",
    "plus.cta": "VALUS+，每月 $2 无限使用",
    "plus.fineprint": "通过 Stripe 安全付款。随时取消；你的权限会持续到当前计费周期结束。",
    "signin.detail": "VALUS 无需账户即可免费使用：搜索任意股票、拖动 DCF 滑块、浏览排行榜，全部无需登录。仅当你想跨设备保存组合或发布到公开排行榜时才需登录。",
    "signin.google": "使用 Google 继续",
    "etf.52wHigh": "52 周最高",
    "etf.52wLow": "52 周最低",
    "etf.ytd": "年初至今",
    "etf.expense": "费用率",
    "btc.tagline": "人类历史上最伟大的资产。<br/><span>坚不可摧。势不可挡。不可侵犯。</span>",
    "lb.title": "排行榜",
    ...
    "footer.contact": "联系",
    "common.back": "返回",
    "lb.subtitle": "看看谁发现了最好的价值标的。按安全边际排序。",
    "lb.sortLabel": "排序：",
    "lb.avgMos": "平均安全边际",
    "lb.recent": "最新",
    "lb.size": "持仓最多",
...
function applyI18n(lang) {
  ...
  // Rich text (contains <br>/<strong> etc.).  The dictionary is fully
  // author-controlled static content, so innerHTML here is safe.
  document.querySelectorAll("[data-i18n-html]").forEach(el => {
    if (!_i18nOrig.has(el)) _i18nOrig.set(el, el.innerHTML);
    el.innerHTML = (dict && dict[el.dataset.i18nHtml]) || _i18nOrig.get(el);
  });
}
